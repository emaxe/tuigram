...
- Доработан показ количества непрочитанных сообщений в списке диалогов: если непрочитанных более 99, отображается `[99+]`, а блок времени и непрочитанных всегда прижат к правому краю с сокращением названия диалога с троеточием при нехватке места.

### Исправлено

- При переходе в диалог с непрочитанными сообщениями лента теперь позиционируется на первом непрочитанном сообщении с визуальным разделителем «Непрочитанные сообщения», как в официальном клиенте Telegram (ранее всегда открывалось последнее сообщение).
- Бейдж и счётчик непрочитанных сообщений в списке диалогов теперь динамически уменьшаются в реальном времени по мере пролистывания и прочтения сообщений в активном чате.
